...
#define USB_DP_SOURCE           GPIO_PinSource11
#define USB_DM_SOURCE           GPIO_PinSource12
#define USB_DISCONNECT_CLK      RCC_AHBPeriph_GPIOA
#define USB_DM_CLK              RCC_AHBPeriph_GPIOA
#define USB_DP_CLK              RCC_AHBPeriph_GPIOA
